...
![Docker versión](Componente2/capturas/docker%20version.png)

#### Dockerfile Frontend

![Dockerfile Frontend](Componente2/capturas/Contenido%20de%20dockerfiles%20-%20frontend.png)

#### Dockerfile Backend

![Dockerfile Backend](Componente2/capturas/Contenido%20de%20dockerfiles%20-%20backend.png)

#### Docker Compose — Parte 1

![Docker Compose parte 1](Componente2/capturas/Docker-compose%201%20parte.png)

#### Docker Compose — Parte 2

![Docker Compose parte 2](Componente2/capturas/Docker-compose%202%20parte.png)

#### Estructura de archivos (tree)

![Tree final](Componente2/capturas/tree%20final.png)

#### Construcción de contenedores — Parte 1

![Build parte 1](Componente2/capturas/Construir%20los%20contenedores%20parte%201.png)

#### Construcción de contenedores — Parte 2

![Build parte 2](Componente2/capturas/Construir%20los%20contenedores%20parte%202.png)

#### Imágenes Docker

![Imágenes Docker](Componente2/capturas/docker%20img%20con%20las%202%20imagenes.png)

#### Contenedores activos

![Contenedores activos](Componente2/capturas/Contenedores%20activos.png)

#### curl al backend

![curl backend](Componente2/capturas/curl%20backend.png)

#### Frontend en navegador

![Frontend funcionando](Componente2/capturas/HTML%20FRONTEND%20inicial%20funcionando.png)
...
![kubectl version](Componente3/capturas/kubectl_version.jpeg)

#### Nodos del clúster

![kubectl get nodes](Componente3/capturas/kubectl_get_nodes.png)

#### Minikube iniciado

![Minikube start](Componente3/capturas/minikube_start.png)

#### Pods con 2 réplicas

![kubectl get pods 2 réplicas](Componente3/capturas/kubectl_get_pods_2replicas.png)

#### Servicio NodePort

![kubectl get svc](Componente3/capturas/kubectl_get_svc.png)

#### URL del servicio

![minikube service url](Componente3/capturas/minikube_service_url.png)

#### Nginx en navegador

![Nginx en navegador](Componente3/capturas/nginx_navegador.png)

#### Escalado a 3 réplicas

![Scale a 3 réplicas](Componente3/capturas/kubectl_scale_3replicas.png)
